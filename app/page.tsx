export default function Dashboard() {
  return (
    <div className="flex min-h-screen">
      <aside className="w-16 hover:w-64 bg-gradient-to-b from-gray-800 to-gray-900 text-white hidden md:block transition-all duration-300 group">
        <div className="p-6 text-2xl font-bold whitespace-nowrap overflow-hidden">
          <span className="group-hover:inline hidden">HOTAL ROYAL</span>
          <span className="group-hover:hidden inline">HR</span>
        </div>
        <nav className="mt-6">
          <a href="#" className="flex items-center gap-4 py-3 px-6 hover:bg-gray-700 transition-colors duration-200">
            <svg className="h-5 w-5 min-w-[1.25rem]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
            </svg>
            <span className="whitespace-nowrap overflow-hidden group-hover:inline hidden">Home</span>
          </a>
          <a href="#" className="flex items-center gap-4 py-3 px-6 hover:bg-gray-700 transition-colors duration-200">
            <svg className="h-5 w-5 min-w-[1.25rem]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
            </svg>
            <span className="whitespace-nowrap overflow-hidden group-hover:inline hidden">Users</span>
          </a>
          <a href="#" className="flex items-center gap-4 py-3 px-6 hover:bg-gray-700 transition-colors duration-200">
            <svg className="h-5 w-5 min-w-[1.25rem]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
            <span className="whitespace-nowrap overflow-hidden group-hover:inline hidden">Rooms</span>
          </a>
          <a href="#" className="flex items-center gap-4 py-3 px-6 hover:bg-gray-700 transition-colors duration-200">
            <svg className="h-5 w-5 min-w-[1.25rem]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span className="whitespace-nowrap overflow-hidden group-hover:inline hidden">Settings</span>
          </a>
        </nav>
      </aside>
        ...
        <header className="bg-white shadow p-4 flex justify-between items-center">
          ...
          <div className="flex-1 max-w-md mx-8">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search users, bookings, or analytics..."
